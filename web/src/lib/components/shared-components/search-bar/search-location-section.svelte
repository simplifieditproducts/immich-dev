...
<div id="location-selection">
  <p class="immich-form-label text-gray-600 text-lg inline-flex items-center -ml-1 gap-x-1"><Icon path={mdiImageMarkerOutline} class="size-7" />Where was it taken?</p>
